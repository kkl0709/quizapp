...
abstract class $VersionCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? version, String? androidVersion, String? iosVersion});
}
...
class _$_Version extends _Version {
  const _$_Version({this.version, this.androidVersion, this.iosVersion})
      : super._();
  ...
  @override
  String toString() {
    return 'Version(version: $version, androidVersion: $androidVersion, iosVersion: $iosVersion)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, version, androidVersion, iosVersion);
...
abstract class _Version extends Version {
  const factory _Version(
      {final String? version,
      final String? androidVersion,
      final String? iosVersion}) = _$_Version;

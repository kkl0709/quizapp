    ...
    return Container(
      ...
      child: Wrap(
        ...
        children: [
          ...
          TextBox(text: "questionScreen_order_1".tr),
          Icon(Icons.arrow_forward_outlined),
          AlphabetBox(alphabet: 'i'),
          TextBox(text: "questionScreen_order_2".tr),
          Icon(Icons.arrow_forward_outlined),
          AlphabetBox(alphabet: 'd'),
          TextBox(text: "questionScreen_order_3".tr),
          Icon(Icons.arrow_forward_outlined),
          AlphabetBox(alphabet: 'g'),
          TextBox(text: "questionScreen_order_4".tr),
          Icon(Icons.arrow_forward_outlined),
          AlphabetBox(alphabet: 'c'),
          TextBox(text: "questionScreen_order_5".tr),
        ],
      ),
      decoration: BoxDecoration(
        color: Color(0xFFFFFFFF),
